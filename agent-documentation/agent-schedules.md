...
| Linda | Daily or on demand | Daily morning before operator planning | Human asks `Linda`, daily status check, major structural edit, new folder or agent, source-of-truth conflict, score drop, or before expanding repo structure | Should produce concise project status, source-backed insights, a repo-health score when relevant, must-look findings, one-day work, and one clarifying question when needed. |
